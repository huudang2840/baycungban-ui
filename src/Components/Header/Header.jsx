...
const Header = (props) => {
  ...
  return (
    <div className={page !== "home" ? "header active" : "header"}>
        ...
        <div className="circle-lang">
          ...
          >
            <g clip-path="url(#clip0_8_702)">
              ...
              />
              <path
                d="M10 5.21738L11.0792 8.53882H14.5716L11.7462 10.5916L12.8254 13.913L10 11.8603L7.17461 13.913L8.25383 10.5916L5.42844 8.53882H8.92078L10 5.21738Z"
                fill="#FFDA44"
              />
            </g>
            <defs>
        ...
        <div>
          ...
          >
            <g clip-path="url(#clip0_8_723)">
              ...
              />
              <path
                d="M9.56522 10H20C20 9.09744 19.8797 8.22306 19.6555 7.3913H9.56522V10Z"
                fill="#D80027"
              />
              <path
                d="M9.56522 4.78263H18.5322C17.9201 3.78372 17.1374 2.90079 16.2248 2.17392H9.56522V4.78263Z"
                fill="#D80027"
              />
              <path
                d="M10 20C12.3535 20 14.5166 19.1866 16.2248 17.8261H3.77515C5.48335 19.1866 7.64652 20 10 20Z"
                fill="#D80027"
              />
              <path
                d="M1.46772 15.2174H18.5323C19.0237 14.4155 19.4048 13.5389 19.6555 12.6087H0.344482C0.595146 13.5389 0.976279 14.4155 1.46772 15.2174Z"
                fill="#D80027"
              />
              <path
      ...
      <div className="header__center">
        <a href="/">Promotion</a>
        <a className={page !== "home" ? "active-a " : ""} href="/">
          Flight Schedule
        </a>
        <a href="/">About us</a>
      ...
      <di className="header__right">
        <button className={page !== "home" ? "btn btn-active" : "btn"}>Booking now</button>
      </di>
    </div>
  );
};
